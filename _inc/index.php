<?php 
  ...
  $archivesdir = $_SERVER["DOCUMENT_ROOT"] . "root/full";
      ...
      <?php
        ...
        foreach (new DirectoryIterator($currentdir) as $fileinfo) {
          ...
          if ($fileinfo->isDir() && !$fileinfo->isDot()) {
            ...
            //si les dossiers sont vides, on les affiche
            ...
            //si les fichiers ont une extension "cool" , on les affiche
        ...
        //display the parent link if the folder is empty
        if ($params) {
